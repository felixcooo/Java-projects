	...
	public class MyCalculator {
		...
		public static void main(String[] args) {
		    ...
		    // Everything inside of "do" statement for the calculator to start all over again.
		    ...
		    while (!mode.equals("Standard") && !mode.equals("Scientific") && !mode.equals("standard") && !mode.equals("scientific")){
		    ...
		    if(mode.equals("Scientific") || mode.equals("scientific")){
			    ...
			    while(!mathOperator.equals("+") && !mathOperator.equals("-") && !mathOperator.equals("*") && !mathOperator.equals("/")
			    	&& !mathOperator.equals("sin") && !mathOperator.equals("cos") && !mathOperator.equals("tan")){
		    ...
		    if(mathOperator.equals("-")) {
		    	...
		    	System.out.printf("Enter %.0f numbers\n", numbers);
		    		...
		    		if(i == 1) { 
		    			results = subtract; //assign the biggest positive number to subtract to make the subtraction
		    			
		    		}//end if
		    		
		    		else {
		    		results =  results - subtract; //Double results here is the biggest positive number to make the subtraction.
		    ...
		    // Multiplication
		    	...
		    	if (mathOperator.equals("*")) {
			    	...
			    	results = 1; //Must be change outside outside of the loop to a value of 1 because results will be 0 if everything is multiplicative  by 0.
			    	...
			    	for(int i = 1; i <= numbers; i++) { //Loop to enter as many numbers from input.
			    		...
			    		results = results * product; //Result (results) is equal to the product of all the numbers from input(product).
		    		...
		    		if(mathOperator.equals("/")) {
		    	    	...
		    	    	System.out.printf("Enter %.0f numbers\n", numbers);
	                      ...
	                      for(int i = 1; i <= numbers; i++) { //Loop to enter as many numbers from input.
		    	    		...
		    	    		// The first number must be the biggest positive number to subtract.
				    		if(i == 1) { 
				    			results = division; //assign the biggest number to the denominator to make the division.
				    			
				    		}//end if
				    		
				    		else {
				    		results =  results / division; //Double results here is the biggest number in the denominator to make the division.
		    			...
		    			//Cosine of one number.
		    				...
		    				//Tangent of one number.
		    					...
		    					if(mathOperator.equals("tan")){
			    					...
			    					numbers = input.nextDouble(); //One number input from user to calculate tangents.
